...
(use-package ivy
  ...
  (defun my/ivy-next-line-and-call (&optional arg)
    (interactive "p")
    (ivy-next-line-and-call arg)
    (with-ivy-window (recenter)))
  (defun my/ivy-previous-line-and-call (&optional arg)
    (interactive "p")
    (ivy-previous-line-and-call arg)
    (with-ivy-window (recenter)))
  :config
