  ...
  (progn
    ...
    (setq shackle-rules
          ...
          '((compilation-mode          :select nil                                                )
            ...
            (help-mode                 :select t    :inhibit-window-quit t :other t               )
            (helpful-mode              :select t                           :size 0.3  :align t    )
            (flycheck-error-list-mode  :select nil                         :size 0.3  :align t    )
            ;; (deadgrep-mode             :select t    :inhibit-window-quit t :size 0.3  :align t    )
